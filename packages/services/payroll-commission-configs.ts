...
export async function listPayrollCommissionConfigs(
...
export async function createPayrollCommissionConfig(
    supabase: SupabaseClient,
...
export async function updatePayrollCommissionConfig(
    supabase: SupabaseClient,
