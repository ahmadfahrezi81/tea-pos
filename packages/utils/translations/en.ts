export const en = {
    common: {
        ...
        // Keyed by the API's dayOfWeek values, lowercased
        weekdaysFull: {
            monday: "Monday",
            tuesday: "Tuesday",
            wednesday: "Wednesday",
    ...
    home: {
        ...
        selectStoreDesc: "Select a store to manage",
        hideInactiveStores: "Hide demo and inactive stores",
        storeInactive: "INACTIVE",
        weatherDesc: "Hourly weather forecast",
    ...
    analytics: {
        ...
        avgCupsByDay: "Average cups by day",
        bestDay: "Best day",
        avgCups: "Avg Cups",
        ...
        dailySalesBreakdownTitle: "Breakdown",
        highestDay: "Highest day",
        lowestDay: "Lowest day",
        teaWasteTitle: "Tea Waste",
        teaWasteSubtitle: "Litres wasted at closing",
        teaWasteCostTitle: "Wasted cost",
        teaWasteLitresWasted: "Litres wasted",
        teaWasteCostPerLitre: "Cost per litre",
        teaWasteTotalCost: "Total wasted",
    },
    daily: {
        store: "Store",
        openedBy: "Opened by",
    ...
    manage: {
        ...
        custom: "Custom",
        requestNotesPlaceholder: "Any extra details? (optional)",
        reportNotesPlaceholder: "Describe what happened",
        incidentTypePlaceholder: "Describe the incident type...",
        photoCompressing: "Compressing...",
        photoRetake: "Retake",
        photoTapToAdd: "Tap to add photo",
        photoProcessFailed: "Failed to process photo. Please try again.",
        photoErrorTitle: "Photo Error",
        photoErrorDesc: "An error occurred while processing the photo",
        cameraBlockedTitle: "Camera Access Blocked",
        cameraBlockedDesc: "Camera permission is required to take photos",
        cameraBlockedBody: "This app needs camera access to take photos.",
        cameraStep1: "Open your phone's Settings",
        cameraStep2: "Go to Apps → your browser",
        cameraStep3: "Tap Permissions → Camera → Allow",
    ...
    claims: {
        ...
        noEntitlementsYet: "No entitlements yet",
        noEntitlementsHint: "Ask your manager to assign claim types to you.",
        freqDaily: "Daily",
        sourceAutoSubmit: "Auto submit",
        sourceManual: "Manual",
    },
    earnings: {
        title: "My Pay",
        ...
        cups: "cups",
        commissionsRow: "Commission",
        claimsRow: "Claims",
        pendingReview: "Pending review",
        statusRejected: "Rejected",
        autoRejectedNeeded: "Needed",
        autoRejectedWorked: "worked",
        totalRow: "Total",
