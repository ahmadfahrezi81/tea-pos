...
} from "@tea-pos/features/weather/schema";
...
interface WeatherDrawerProps {
    isOpen: boolean;
    onClose: () => void;
    /** Forecast to render. Each app fetches it through its own hook and route. */
    data?: WeatherHourlyResponse;
    isLoading?: boolean;
    /** Resolves a dotted message key to display text. */
    t: (key: string) => string;
}

// ─── Component ────────────────────────────────────────────────────────────────

export function WeatherDrawer({ isOpen, onClose, data, isLoading, t }: WeatherDrawerProps) {
