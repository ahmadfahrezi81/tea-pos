...
// lib/schemas/userStoreAssignments.ts
import { z } from "zod";
import { UUIDSchema } from "./common";
...
export const ListStoreAssignmentsQuery = z
    .object({
        storeId: UUIDSchema.openapi({
            description: "ID of the store to list assignments for",
        }),
        tenantId: UUIDSchema.optional().openapi({
            description: "Optional tenant ID for additional filtering",
        }),
    })
    .openapi({ title: "ListStoreAssignmentsQuery" });
...
// Enhanced response with profile data for listing users in a store
export const StoreUserResponse = z
    .object({
        id: UUIDSchema,
        userId: UUIDSchema,
        storeId: UUIDSchema,
    ...
    .openapi({ title: "StoreUserResponse" });

export const ListStoreAssignmentsResponse = z
    .object({
        assignments: z.array(StoreUserResponse),
    })
    .openapi({ title: "ListStoreAssignmentsResponse" });
...
export type CreateAssignmentInput = z.infer<typeof CreateAssignmentInput>;
export type UpdateAssignmentInput = z.infer<typeof UpdateAssignmentInput>;
export type ListStoreAssignmentsQuery = z.infer<
    typeof ListStoreAssignmentsQuery
>;
export type DeleteAssignmentQuery = z.infer<typeof DeleteAssignmentQuery>;
export type AssignmentResponse = z.infer<typeof AssignmentResponse>;
export type StoreUserResponse = z.infer<typeof StoreUserResponse>;
export type ListStoreAssignmentsResponse = z.infer<
    typeof ListStoreAssignmentsResponse
>;
export type CreateAssignmentResponse = z.infer<typeof CreateAssignmentResponse>;
export type UpdateAssignmentResponse = z.infer<typeof UpdateAssignmentResponse>;
export type DeleteAssignmentResponse = z.infer<typeof DeleteAssignmentResponse>;
...
export type Assignment = z.infer<typeof AssignmentResponse>;
export type StoreUser = z.infer<typeof StoreUserResponse>;
