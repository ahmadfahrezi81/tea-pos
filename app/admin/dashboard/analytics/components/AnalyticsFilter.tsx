// // dashboard/analytics/components/AnalyticsFilter.tsx
...
//     summaryIdSearch: string;
//     onSummaryIdSearchChange: (search: string) => void;
//     stores: Store[];
//     totalSummaries: number;
//     filteredSummariesCount: number;
//     onClearFilters: () => void;
...
//                         <input
//                             type="text"
//                             placeholder="Search by Summary ID..."
//                             value={summaryIdSearch}
//                             onChange={(e) =>
//                                 onSummaryIdSearchChange(e.target.value)
//                             }
...
//                     Showing {filteredSummariesCount} of {totalSummaries} daily
//                     summaries
...
import { Search, Calendar, Store as StoreIcon, X } from "lucide-react";
import { Store } from "../types/analytics";
        ...
        <div className="bg-white p-6 rounded-lg shadow mb-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select
                        ...
                        onChange={(e) => onStoreSelectionChange(e.target.value)}
                        className="w-full p-2.5 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 text-sm"
                    >
            ...
            <div className="flex justify-between items-center pt-2 border-t border-gray-200">
                <div className="text-sm text-gray-600">
                    ...
                    {!selectedStoreId && totalSummaries > 0 && (
                        <span className="ml-2 text-orange-600">
                            • Please select a store to view summaries
                        </span>
                    )}
                </div>
