// app/[tenantSlug]/admin/[storeId]/users/_components/data-table.tsx
...
const STORE_ROLES = ["seller", "manager"];
                ...
                <div className="flex items-center gap-2 flex-1">
                    <Input
                        ...
                        onChange={(event) => {
                            ...
                            // Also filter by userId if input looks like USR-
