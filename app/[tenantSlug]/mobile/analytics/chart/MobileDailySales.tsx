...
export default function MobileDailySales() {
    ...
    const { data: dayOfWeekData, isLoading: dayOfWeekLoading } =
        useDayOfWeekSales(selectedStore, selectedMonth);
    ...
    const dayOfWeekSales = useMemo(() => {
        return dayOfWeekData?.data ?? [];
    }, [dayOfWeekData]);

    // Transform day of week data with colors:
    const dayOfWeekChartData = useMemo(() => {
        return dayOfWeekSales.map((item) => ({
            ...item,
