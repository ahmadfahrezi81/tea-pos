...
import { Check, UserCircle, Minus } from "lucide-react";
        ...
        <div className={`space-y-4 ${showConfirmation ? "pb-4" : "pb-24"}`}>
            ...
            <div className="bg-white rounded-2xl p-3 space-y-2">
                ...
                <div className="bg-blue-100 p-2 rounded-lg">
                    <p className="text-xs font-semibold text-gray-700">{t("analytics.openingBalance")}</p>
                    <p className="text-xl font-bold text-blue-900">{formatRupiah(summary.openingBalance)}</p>
                </div>
                ...
                <div className="grid grid-cols-4 gap-2">
                    ...
                    <div className="col-span-2 bg-green-100 p-2 rounded-lg">
                        <p className="text-xs font-semibold text-gray-700">+ {t("analytics.totalSales")}</p>
                        <p className="text-xl font-bold text-green-900">{formatRupiah(summary.totalSales)}</p>
                    </div>
                    ...
                    <div className="col-span-1 bg-violet-100 p-2 rounded-lg">
                        ...
                        <p className="text-xl font-bold text-violet-900">{summary.totalOrders}</p>
                    </div>

                    {/* Cups */}
                    <div className="col-span-1 bg-orange-100 p-2 rounded-lg">
                        <p className="text-xs font-semibold text-gray-700">{t("analytics.cups")}</p>
                        <p className="text-xl font-bold text-orange-900">{summary.totalCups}</p>
                    </div>
                </div>

                {/* Opening + Sales */}
                <div className="bg-blue-100 p-2 rounded-lg">
                    <p className="text-xs font-semibold text-gray-700">{t("analytics.openingBalance")} + {t("analytics.totalSales")}</p>
                    <p className="text-xl font-bold text-blue-900">{formatRupiah(summary.openingBalance + summary.totalSales)}</p>
                </div>
                ...
                <div className="bg-red-100 p-2 rounded-lg">
                    <p className="text-xs font-semibold text-gray-700">− {t("daily.expenses")}</p>
                    <p className="text-xl font-bold text-red-900">{formatRupiah(summary.totalExpenses)}</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-purple-100 p-2 rounded-lg">
                        <p className="text-xs font-semibold text-gray-700">{t("analytics.expectedCash")}</p>
                        <p className="text-xl font-bold text-purple-900">{formatRupiah(summary.expectedCash)}</p>
                    </div>

                    {/* Actual Cash */}
                    <div className="bg-amber-100 p-2 rounded-lg">
                        <p className="text-xs font-semibold text-gray-700">{t("analytics.actualCash")}</p>
                ...
                {summary.variance !== null && summary.variance !== undefined && (
                    <div className={`p-2 rounded-lg ${summary.variance >= 0 ? "bg-green-100" : "bg-red-100"}`}>
                            <p className="text-xs font-semibold text-gray-700">{t("analytics.variance")}</p>
                            <p className={`text-xl font-bold ${summary.variance >= 0 ? "text-green-900" : "text-red-900"}`}>
