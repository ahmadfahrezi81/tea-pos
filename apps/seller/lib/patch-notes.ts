...
export const patchNotes: PatchNote[] = [
    {
        ...
        date: "2026-09-19",
        entries: [
            { kind: "improved", text: "Pull down to refresh is now on the screens where information can actually change." },
        ],
    },
    {
        version: "5.4.18",
    ...
    },
    {
        ...
        date: "2026-08-26",
        entries: [
            { kind: "improved", text: "The Home screen no longer flashes blank while it works out whether the store is open." },
        ],
    },
    {
        version: "5.4.13",
