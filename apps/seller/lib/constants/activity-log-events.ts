...
export const EVENT_ICON: Record<string, LucideIcon> = {
    ...
    summary_photo_uploaded: Image,
    summary_photo_deleted: Trash2,
    summary_photo_updated: Hash,
...
export const EVENT_COLOR: Record<string, string> = {
    ...
    store_opened: "bg-green-500",
    store_closed: "bg-gray-500",
    ...
    opening_balance_updated: "bg-blue-400",
    summary_photo_uploaded: "bg-teal-400",
    summary_photo_deleted: "bg-red-400",
    summary_photo_updated: "bg-teal-400",
...
export const EVENT_LABEL: Record<string, string> = {
    ...
    summary_photo_uploaded: "Photo uploaded",
    summary_photo_deleted: "Photo deleted",
    summary_photo_updated: "Photo updated",
