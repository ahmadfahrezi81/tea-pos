...
// import { formatRupiah } from "@tea-pos/utils/cn/formatCurrency";
...
export const CloseDayModal = ({
    ...
    useEffect(() => {
        if (summary?.expectedCash != null) {
            setCloseForm({
                actualCash: summary.expectedCash.toString(),
                notes: "",
            });
        }
    }, [summary?.expectedCash, summary?.totalSales]);
                ...
                <div className="flex-1 overflow-y-auto">
                    <div className="p-4 space-y-4">
                        <div className="bg-blue-50 p-4 rounded-lg">
                            ...
                            <p className="text-sm text-blue-600">
                                Opening: {formatRupiah(summary.openingBalance)}{" "}
                                + Sales: {formatRupiah(summary.totalSales)} -
                                Expense: {formatRupiah(summary.totalExpenses)}
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            {closeForm.actualCash && (
                                <div
                                    className={`p-4 rounded-lg ${
                                        parseFloat(closeForm.actualCash) -
