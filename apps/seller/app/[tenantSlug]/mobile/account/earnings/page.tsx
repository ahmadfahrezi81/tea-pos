        ...
        <div className="space-y-3">
            ...
            <div className="bg-white rounded-xl p-4">
                ...
                {rateLoading ? (
                    ...
                    <p className="text-base font-medium text-amber-600">No rate configured</p>
                ) : (
                    <>
            ...
            {isLoading ? (
                ...
                <p className="text-center text-gray-400 py-10 text-base">No payroll periods yet.</p>
            ) : (
                <div className="space-y-2">
                            ...
                            >
                                <div className="flex-1 min-w-0">
                                    ...
                                    {hasEntries ? (
                                        ...
                                        <p className="text-sm text-gray-400">No shifts · Rp 0</p>
                                    )}
                                </div>
