...
export default function Manage() {
    ...
    // Not memoized: a find over at most 48 rows plus a lookup. The useMemo this
    // replaces made the compiler bail on the whole component, which costs more
    // than the work it was saving.
    ...
    const WeatherIcon = currentWeather
        ? getWeatherMeta(currentWeather.weatherCode, isNightHour(currentLocalHour)).fluentIcon
        : null;
