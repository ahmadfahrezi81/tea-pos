...
import { listPayouts } from "@tea-pos/services/payroll";
...
export async function GET(request: NextRequest) {
    try {
        ...
        const payouts = await listPayouts(supabase, { tenantId, userId: user.id, startDate: query.data.startDate, endDate: query.data.endDate });
